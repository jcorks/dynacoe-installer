...
Dim res 
res = shell.Run("..\bootstrap\wget.exe http://heanet.dl.sourceforge.net/project/msys2/Base/x86_64/msys2-base-x86_64-20160719.tar.xz", 1, true)
If res <> 0 Then
...
Set fileSrc = fs.GetFile(".\msys2-base-x86_64-20160719.tar.xz")
